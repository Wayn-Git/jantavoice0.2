                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    <div className="flex gap-1">
                      <Link to={`/complaint/${c._id}`} className="w-7 h-7 bg-gray-100 hover:bg-saffron-pale rounded-lg flex items-center justify-center text-gray-500 hover:text-saffron transition-colors">
                        <FaEye className="text-xs" />
                      </Link>
                      <button onClick={() => handleDelete(c._id)} className="w-7 h-7 bg-gray-100 hover:bg-red-50 rounded-lg flex items-center justify-center text-gray-400 hover:text-red-500 transition-colors">
